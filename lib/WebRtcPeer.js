...
function WebRtcPeer(mode, options, callback) {
  ...
  if (options.configuration && options.configuration.iceServers) {
    configuration.iceServers = options.overrideIceServers ? options.configuration.iceServers : configuration.iceServers.concat(options.configuration.iceServers);
  }
